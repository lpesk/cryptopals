...
@given(test_msg=builds(randMsg, bdd_integers()), block_size=integers(min_value=1, max_value=255))
...
@mark.parametrize('strict', [True, False])
@given(test_msg=builds(randMsg, bdd_integers()), block_size=integers())
